...
image = Image.open(r'C:\Users\mahen\Downloads\sheet-removebg-preview.png')
...
for _ in range(6):
    image.crop((x,0,y,120)).save(rf'S:\platform\running\running{_}.png')
    (x,y) = x+85,y+80
...
# cv = cv2.__dict__
#
# image = cv['imread'](r"S:\platform\stand\stand.png")
# Rotated1_image = imutils.rotate(image, angle=10)
#
...
# # cv['waitKey'](0)
#
# for index,path in enumerate(pygamee.game.runningSprites):
#     image2 = Image.open(path)
#     image2.transpose(Image.FLIP_LEFT_RIGHT).save(f's:/platform/leftrunning/leftrunning{index}.png')
#
