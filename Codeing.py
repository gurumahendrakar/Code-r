...
# #
# # #
# # # hexa = ("Guru".encode().hex())
# # #
# # # for _ in "Guru".encode():
# # #     print(_,hex(_),end=" ")
# # #
# # # else:
# # #     print()
...
#         nextNode = self.node
#         self.value = value
#         self.node = Node(prevValue,nextNode)
#
#
#
...
#
#         if (self.__node):
#             currentNodeValue = self.__node.value
#             self.__node = self.__node.node
#             return currentNodeValue
#
#         else:
#             raise StopIteration("values are finished")
#
#
#
# Node_O = Node(0,False)
...
utf_18_char = "�4,�R�h�X�34z�/"


for c in utf_18_char.encode():
    print(utf_18_char.encode().hex())