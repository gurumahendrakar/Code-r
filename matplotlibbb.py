...
# #
# # titanic = sea.load_dataset('titanic')
# # va = np.array([1,2,3,53,5,35,35,2,3,4,5,6,7,8,11,22,55,53,435,34,35])
# # print('std = ',np.sqrt(sum((va-va.mean())*(va-va.mean()))/len(va)))
# #
# #
# # print(va.std())
...
# # mean = (data-data.mean())
# #
# # print(np.sqrt(sum(mean*mean)/len(data)))
# #
# #
# # print(pd.Series(data).std())
# # #
# #
...
# #
# #
# # print(np.mean(data),'my __ mean ',np.sum(data)/len(data))
# # print(np.std(data),'my __ std',np.sqrt(np.sum(data*data)/(len(data)+1)))
#
#
#
#
#
#
# data = np.array([300,535,353,3534,333,3434,343,2343,2343])
# varience = sum( (data-np.mean(data)) * (data-np.mean(data)))/len(data)
#
# print(pd.Series(data).describe())
# sea.kdeplot(data)
# sea.boxplot(data,orient='horizontal')
#
# plt.show()
...
groupby = titanic.groupby('sex')

for x in (groupby):
    xx = (x[1].survived.value_counts())
    xx.index = ['Survived','Died']
    ...
    sea.barplot(x=xx.index,y=xx.values,hue=x[1].sex //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////)
