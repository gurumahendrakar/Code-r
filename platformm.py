    ...
    def main_content(self):
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if ((event.key == pygame.K_LEFT) and value.afterdown_rightClicked<3) or ((event.key==pygame.K_LEFT) and value.value_stand):
                ...
                elif ((event.key == pygame.K_RIGHT) and value.afterdown_rightClicked<3) or ((event.key==pygame.K_RIGHT) and value.value_stand):
